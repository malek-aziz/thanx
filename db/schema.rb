...
ActiveRecord::Schema[7.1].define(version: 2024_03_13_223644) do
  create_table "redemptions", charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "rewards", charset: "utf8mb4", force: :cascade do |t|
